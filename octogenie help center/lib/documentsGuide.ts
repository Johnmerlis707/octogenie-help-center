...
export const uploadDocumentsGuide: GuideSection = {
  ...
  description: "Follow these steps to upload documents to your central document repository.",
  estimatedTime: "3 min",
  totalSteps: 6,
  steps: [
    {
    ...
    },
    {
      ...
      image: "/assets/matters/matters-page4-img2.png",
...
export const linkDocumentsGuide: GuideSection = {
  ...
  steps: [
    ...
    },
    {
      ...
      image: "/assets/matters/matters-page5-img2.png",
    ...
    },
    {
      ...
      image: "/assets/matters/matters-page10-img1.png",
    ...
    },
    {
      ...
      image: "/assets/matters/post-updating-details-(click-on-create-matter-buuton).png",
